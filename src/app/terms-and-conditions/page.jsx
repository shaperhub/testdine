  ...
  return (
    <div className=''>
      <div className='bg-white dark:bg-black text-black dark:text-white'>
        ...
        <br></br>
        <h2>Compliance with Children's Privacy</h2>
        ...
        <ul>
          <li>Subscription Terms: Your subscription will automatically renew at the end of each billing cycle unless you cancel it before the renewal date. You can manage your subscription settings within the app.</li>
          <li>Cancellation: You may cancel your subscription at any time. Your subscription will remain active until the end of the current billing period, after which it will not be renewed.</li>
          <li>Refunds: Refunds are not provided for any unused portion of the current subscription period. In case of a dispute or special circumstance, please contact our support team at support@dineintel.io.</li>
        </ul>
        <br></br>
        <h2>Contact Us</h2>
        <p>For any questions or concerns regarding these Terms and Conditions, please contact us at info@dineintel.io.</p>
        <br></br>
      </div>
    </div>
  )
