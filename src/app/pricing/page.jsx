  ...
  return (
    <div className='text-ddarkgrey dark:text-dgrey font-regular'>
      ...
      <div className='px-8 md:px-24 py-24 bg-dlightestgreen/90 dark:bg-dblack/90'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-8'>
          <div className='mb-4 p-4 rounded-[24px] bg-white dark:bg-black'>
            <h4 className='font-bold mb-4 text-dgreenw dark:text-dgreen'>Tailored Recommendations</h4>
          ...
          <div className='mb-4 p-4 rounded-[24px] bg-white dark:bg-black'>
            <h4 className='font-bold mb-4 text-dgreenw dark:text-dgreen'>My Dish Insight</h4>
            <p className='mb-4 text-justify'>
          ...
          <div className='mb-4 p-4 rounded-[24px] bg-white dark:bg-black'>
            <h4 className='font-bold mb-4 text-dgreenw dark:text-dgreen'>Community Connect</h4>
            <p className='mb-4 text-justify'>
          ...
          <div className='mb-4 p-4 rounded-[24px] bg-white dark:bg-black'>
            <h4 className='font-bold mb-4 text-dgreenw dark:text-dgreen'>Culinary Tracker</h4>
            <p className='mb-4 text-justify'>
          ...
          <div className='mb-4 p-4 rounded-[24px] bg-white dark:bg-black'>
            <h4 className='font-bold mb-4 text-dgreenw dark:text-dgreen'>Enhanced Discovery</h4>
            <p className='mb-4 text-justify'>
      ...
      <div className='px-8 md:px-24 py-24 bg-white/80 dark:bg-black/90'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-8'>
          <div className='mb-4 p-4 rounded-[24px] bg-dlightgreen dark:bg-dlightblack'>
            <h4 className='font-bold mb-4 text-dgreenw dark:text-dgreen'>Expanded Choices</h4>
            <p className='mb-4 text-justify'>
          ...
          <div className='mb-4 p-4 rounded-[24px] bg-dlightgreen dark:bg-dlightblack'>
            <h4 className='font-bold mb-4 text-dgreenw dark:text-dgreen'>Dish Customization</h4>
            <p className='mb-4 text-justify'>
          ...
          <div className='mb-4 p-4 rounded-[24px] bg-dlightgreen dark:bg-dlightblack'>
            <h4 className='font-bold mb-4 text-dgreenw dark:text-dgreen'>Exclusive Groups</h4>
            <p className='mb-4 text-justify'>
          ...
          <div className='mb-4 p-4 rounded-[24px] bg-dlightgreen dark:bg-dlightblack'>
            <h4 className='font-bold mb-4 text-dgreenw dark:text-dgreen'>Dining Diary</h4>
            <p className='mb-4 text-justify'>
          ...
          <div className='mb-4 p-4 rounded-[24px] bg-dlightgreen dark:bg-dlightblack'>
            <h4 className='font-bold mb-4 text-dgreenw dark:text-dgreen'>No More Guesswork</h4>
            <p className='mb-4 text-justify'>
      ...
      <div className='px-8 md:px-24 py-24 bg-dlightestgreen/90 dark:bg-dblack/90'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-8'>
          <div className='mb-4 p-4 rounded-[24px] bg-white dark:bg-black'>
            <h4 className='font-bold mb-4 text-dgreenw dark:text-dgreen'>Unlimited Personalization</h4>
            <p className='mb-4 text-justify'>
          ...
          <div className='mb-4 p-4 rounded-[24px] bg-white dark:bg-black'>
            <h4 className='font-bold mb-4 text-dgreenw dark:text-dgreen'>In-Depth Health Insights</h4>
            <p className='mb-4 text-justify'>
          ...
          <div className='mb-4 p-4 rounded-[24px] bg-white dark:bg-black'>
            <h4 className='font-bold mb-4 text-dgreenw dark:text-dgreen'>Comprehensive Meal Chronicles</h4>
            <p className='mb-4 text-justify'>
          ...
          <div className='mb-4 p-4 rounded-[24px] bg-white dark:bg-black'>
            <h4 className='font-bold mb-4 text-dgreenw dark:text-dgreen'>First-Class Support</h4>
            <p className='mb-4 text-justify'>
