...
const Faqs = () => {
  return (
    <div className='min-h-screen text-black dark:text-white bg-white/70 dark:bg-black/90'>
      <div data-aos="fade-up" className='pt-28 pb-16 px-8 md:px-36'>
        <h1 className="font-heading text-4xl mb-8 text-center">Frequently Asked Questions</h1>
        ...
        <div className='flex flex-col items-center py-4'>
          ...
          <button className='p-3 bg-dgreenw/10 dark:bg-dgreenw/20 rounded-xl text-dgreenw font-bold'>
