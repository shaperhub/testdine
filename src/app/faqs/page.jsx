...
const Faqs = () => {
  return (
    <div className='min-h-screen text-black dark:text-white bg-white/70 dark:bg-black/90'>
      <div data-aos="fade-up" className='pt-28 pb-16 px-8 md:px-24'>
        ...
        <Accordion type="single" collapsible className="font-regular">
          <AccordionItem value="item-1">
            ...
            <AccordionContent className="text-ddarkgrey dark:text-dgrey">
        ...
        <button className='p-3 bg-dgreen/10 dark:bg-dgreen/20 rounded-xl text-dgreen font-bold'>
