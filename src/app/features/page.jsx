      ...
      <div className='px-8 md:px-24 py-12 md:py-16 lg:py-24 bg-white dark:bg-dblack/90'>
        <div className="mb-8">
          <div className="flex justify-center items-center gap-4">
            ...
            <h2 className='font-heading text-lg md:text-2xl lg:text-3xl mb-6 text-dbluew dark:text-dlightblue text-center'>For You: Tailored Culinary Discovery</h2>
          </div>
      ...
      <div className='px-8 md:px-24 py-8 md:py-16 lg:py-24 bg-white dark:bg-dblack/90'>
        <div className='mb-8'>
          <div className="flex justify-center items-center gap-4">
            ...
            <h2 className='font-heading text-lg md:text-2xl lg:text-3xl mb-6 text-dbluew dark:text-dlightblue text-center'>Modify Dish: Sophisticated Culinary Customization</h2>
          </div>
          <p className='mb-4 text-center lg:px-36 lgxl:px-72 lg:text-2xl text-dbluew dark:text-dgrey'>
      ...
      <div className='px-8 md:px-24 py-8 md:py-16 lg:py-24 bg-white dark:bg-dblack/90'>
        <div className='mb-8'>
          <div className="flex justify-center items-center gap-4">
            ...
            <h2 className='font-heading text-lg md:text-2xl lg:text-3xl mb-6 text-dbluew dark:text-dlightblue text-center'>Dine Group: Your Culinary Community Platform</h2>
          </div>
          <p className='mb-4 text-center lg:px-36 lgxl:px-72 lg:text-2xl text-dbluew dark:text-dgrey'>
      ...
      <div className='px-8 md:px-24 py-24 bg-white dark:bg-dblack/90'>
        <div className='mb-8'>
          <div className="flex justify-center items-center gap-4">
            ...
            <h2 className='font-heading text-lg md:text-2xl lg:text-3xl mb-6 text-dbluew dark:text-dlightblue text-center'>Epicurean Concierge: Your Ultimate Culinary Guide</h2>
          </div>
          <p className='mb-4 text-center lg:px-36 lgxl:px-72 lg:text-2xl text-dbluew dark:text-dgrey'>
        ...
        <div className='flex flex-col justify-center items-center gap-8 px-8 md:px-16 lg:px-32 lgxl:px-64 py-12 bg-white dark:bg-black'>
          ...
          <div className='flex flex-col md:flex-row'>
            <Link href="https://apps.apple.com/us/app/dineintel/id6532628448" className='mb-4 mr-4' aria-label="DineIntel Apple Appstore Link">
            ...
            <Link href="" className='mb-4' aria-label="DineIntel Google Playstore Link">
              <svg width="120" height="40" viewBox="0 0 120 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="0.5" y="0.5" width="119" height="39" rx="5.5" fill="black"/>
                <rect x="0.5" y="0.5" width="119" height="39" rx="5.5" stroke="#A6A6A6"/>
