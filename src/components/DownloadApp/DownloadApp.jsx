  ...
  return (
    <div className='flex flex-col lg:flex-row gap-16 px-8 md:px-24 lgmd:px-32 p-8 md:p-16 lg:p-20 2xl:justify-center bg-transparent text-dbluew dark:text-dlightblue font-heading'>
        <div className='flex flex-col justify-center lgxl:max-w-[500px]'>
            <div className=''>
                <h2 className='font-heading text-2xl md:text-3xl mb-6'>Discover a world of personalized dining experiences at your command.</h2>
            </div>
            <div className='flex'>
        ...
        <div className='lg:flex justify-end lg:max-h-[200px] lgmd:max-h-[300px] lg1440:max-h-[500px]'>
            <Image className='dark:hidden' src={AppShot} width={300} height={300} alt='DineIntel App Screenshot' />
            <Image className='hidden dark:flex' src={AppShotdark} width={300} height={300} alt='DineIntel App Screenshot Darkmode' />
        </div>
    </div>
  )
}
